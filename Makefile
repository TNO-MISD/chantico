...
# ghcr.io/chantico-project/chantico-bundle:$VERSION and ghcr.io/chantico-project/chantico-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/chantico-project/images/chantico:latest
