...
import (
	...
	"ci.tno.nl/gitlab/ipcei-cis-misd-sustainable-datacenters/wp2/energy-domain-controller/chantico/internal/controller"
...
func main() {
	...
	if err = (&controller.MeasurementReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Measurement")
		os.Exit(1)
	}
