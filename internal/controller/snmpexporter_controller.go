...
// // SNMPExporterReconciler reconciles a SNMPExporter object
...
// // +kubebuilder:rbac:groups=chantico.ci.tno.nl,resources=snmpexporters/finalizers,verbs=update

// // Reconcile is part of the main kubernetes reconciliation loop which aims to
// // move the current state of the cluster closer to the desired state.
// // TODO(user): Modify the Reconcile function to compare the state specified by
// // the SNMPExporter object against the actual cluster state, and then
// // perform operations to make the cluster state reflect the state specified by
// // the user.
// //
// // For more details, check Reconcile and its Result here:
// // - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.19.0/pkg/reconcile
// func (r *SNMPExporterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
// 		For(&chanticov1alpha1.SNMPExporter{}).
// 		Complete(r)
// }
